...
const base = {
	...
	module: {
		rules: [
			...
			{test: /\.(png|jpg|gif|woff|svg|eot|ttf|woff2)$/, loader: 'url-loader?limit=1024&name=[name]-[hash:8].[ext]!image-webpack'},
		],
	},
	resolve: {
		alias: {
...
const devConfig = {
	...
	plugins: [HTMLPluginConfig, new webpack.HotModuleReplacementPlugin()],
}

const productionConfig = {
	devtool: 'cheap-module-source-map',
	plugins: [HTMLPluginConfig, productionPlugin]
}
